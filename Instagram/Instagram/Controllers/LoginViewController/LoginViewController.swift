...
class LoginViewController: UIViewController {
    ...
    private func configureHeaderView() {
        ...
        let imageView = UIImageView(image: UIImage(named: "inst"))
    ...
    private func checkEmailAndPassword() {
        viewModel.checkEmailAndPassword(email: usernameEmailField.text, password: passwordField.text)
    }
    
    private func signInUser() {
        viewModel.signInUser(usernames: usernameEmailField.text, email: usernameEmailField.text, password: passwordField.text!) {  [weak self] success in
            DispatchQueue.main.async {
                if success == true {
                    self?.dismiss(animated: true)
                } else {
                    let alert = Alerts.createAlerts(title: "Log in Error", message: "We were unable to log you in.", titleAction: "Dissmis", style: .cancel)
